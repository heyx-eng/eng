...
import org.engdream.common.util.security.Coder;
...
public class FileUploadUtils {
    ...
    private void zipImageFile(InputStream oldFile,
			float quality, String dir) {
		try {
			/** 对服务器上的临时文件进行处理 */
    ...
    private static final String encodingFilename(String filename) {
        ...
        filename = Coder.encryptMD5(filename + System.nanoTime() + counter++)+filename.substring(filename.lastIndexOf("."));
        return filename;
    }
