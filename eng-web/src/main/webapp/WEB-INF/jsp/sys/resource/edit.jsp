...
<body>
	<form:form action="${ctx}/sys/user/update" cssClass="form-horizontal"
		id="editForm" commandName="m">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-body">
					...
					<div class="form-group">
						<label class="control-label col-md-3">跳转链接 </label>
						<div class="col-md-4">
					...
					<div class="form-group">
						<label class="control-label col-md-3">权限 <span
							class="required"> * </span>
						</label>
						<div class="col-md-4">
					...
					<div class="form-group">
						<label class="control-label col-md-3">是否可用 <span
							class="required"> * </span>
						</label>
						<div class="col-md-4">
							<form:radiobuttons path="available" items="${booleanList}"
								itemLabel="info" element="div class=\"app-inline\"" />
							<span class="help-block"></span>
						</div>
					</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#backBtn").on("click", function() {
				location.href = '${ctx}/sys/resource/page/list';
			});
