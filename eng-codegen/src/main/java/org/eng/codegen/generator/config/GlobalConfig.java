...
public class GlobalConfig {
	...
	private String mapperJavaOutputDir = "";
	...
	public String getEntityOutputDir() {
		return entityOutputDir;
	}

	public void setEntityOutputDir(String entityOutputDir) {
		this.entityOutputDir = entityOutputDir;
	}

	public String getMapperJavaOutputDir() {
		return mapperJavaOutputDir;
	}

	public void setMapperJavaOutputDir(String mapperJavaOutputDir) {
		this.mapperJavaOutputDir = mapperJavaOutputDir;
	}
	...
	public void setControllerOutputDir(String controllerOutputDir) {
