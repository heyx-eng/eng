...
public class ConstVal {
	...
	public static final String TEMPLATE_ENTITY = "entity.java.ftl";
	public static final String TEMPLATE_MAPPER = "mapper.java.ftl";
	public static final String TEMPLATE_XML = "mapper.xml.ftl";
	public static final String TEMPLATE_SERVICE = "service.java.ftl";
	public static final String TEMPLATE_SERVICEIMPL = "serviceImpl.java.ftl";
	public static final String TEMPLATE_CONTROLLER = "controller.java.ftl";
